...
/**
    ...
    Each view controller that interacts with Wilddog should have its own ResourceContext.
...
public class ResourceContext : CustomDebugStringConvertible {
    ...
    */
    ...
    /**
        Map from a instance to a Wilddog ref.
    ...
    */
    ...
    /**
        Map from a type to the Wilddog ref where instances of that type are stored.
